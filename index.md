...
The [latest][15] released version is [3.7.1][4] (2025-02-27).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/3.7.1/icewm-3.7.1.tar.lz
$ tar -x --lzip -vpf icewm-3.7.1.tar.lz
$ cd icewm-3.7.1
...
[4]: https://github.com/ice-wm/icewm/releases/download/3.7.1/icewm-3.7.1.tar.lz
