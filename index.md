...
The [latest][15] released version is [2.3.3][4] (2021-04-28).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/2.3.3/icewm-2.3.3.tar.lz
$ tar -x --lzip -vpf icewm-2.3.3.tar.lz
$ cd icewm-2.3.3
...
[4]: https://github.com/ice-wm/icewm/releases/download/2.3.3/icewm-2.3.3.tar.lz
