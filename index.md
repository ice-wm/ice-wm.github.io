...
The [latest][15] released version is [3.2.2][4] (2022-11-14).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/3.2.2/icewm-3.2.2.tar.lz
$ tar -x --lzip -vpf icewm-3.2.2.tar.lz
$ cd icewm-3.2.2
...
[4]: https://github.com/ice-wm/icewm/releases/download/3.2.2/icewm-3.2.2.tar.lz
