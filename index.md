...
The [latest][15] released version is [3.3.4][4] (2023-05-03).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/3.3.4/icewm-3.3.4.tar.lz
$ tar -x --lzip -vpf icewm-3.3.4.tar.lz
$ cd icewm-3.3.4
...
[4]: https://github.com/ice-wm/icewm/releases/download/3.3.4/icewm-3.3.4.tar.lz
