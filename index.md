...
The [latest][15] released version is [2.3.0][4] (2021-04-01).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/2.3.0/icewm-2.3.0.tar.lz
$ tar -x --lzip -vpf icewm-2.3.0.tar.lz
$ cd icewm-2.3.0
...
[4]: https://github.com/ice-wm/icewm/releases/download/2.3.0/icewm-2.3.0.tar.lz
