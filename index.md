...
The [latest][15] released version is [2.2.1][4] (2021-03-02).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/2.2.1/icewm-2.2.1.tar.lz
$ tar -x --lzip -vpf icewm-2.2.1.tar.lz
$ cd icewm-2.2.1
...
[4]: https://github.com/ice-wm/icewm/releases/download/2.2.1/icewm-2.2.1.tar.lz
