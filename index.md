...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/1.8.3/icewm-1.8.3.tar.lz
$ tar -x --lzip -vpf icewm-1.8.3.tar.lz
$ cd icewm-1.8.3
...
[4]: https://github.com/ice-wm/icewm/releases/download/1.8.3/icewm-1.8.3.tar.lz
