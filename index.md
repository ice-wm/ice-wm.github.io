...
The [latest][15] released version is [2.9.1][4] (2021-12-02).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/2.9.1/icewm-2.9.1.tar.lz
$ tar -x --lzip -vpf icewm-2.9.1.tar.lz
$ cd icewm-2.9.1
...
[4]: https://github.com/ice-wm/icewm/releases/download/2.9.1/icewm-2.9.1.tar.lz
