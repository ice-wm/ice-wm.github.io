...
The [latest][15] released version is [3.8.2][4] (2025-08-03).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/3.8.2/icewm-3.8.2.tar.lz
$ tar -x --lzip -vpf icewm-3.8.2.tar.lz
$ cd icewm-3.8.2
...
[4]: https://github.com/ice-wm/icewm/releases/download/3.8.2/icewm-3.8.2.tar.lz
