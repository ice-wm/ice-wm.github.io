...
The [latest][15] released version is [2.9.7][4] (2022-05-02).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/2.9.7/icewm-2.9.7.tar.lz
$ tar -x --lzip -vpf icewm-2.9.7.tar.lz
$ cd icewm-2.9.7
...
[4]: https://github.com/ice-wm/icewm/releases/download/2.9.7/icewm-2.9.7.tar.lz
