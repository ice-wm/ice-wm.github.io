...
The [latest][15] released version is [1.8.2][4] (2020-09-08).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/1.8.2/icewm-1.8.2.tar.lz
$ tar -x --lzip -vpf icewm-1.8.2.tar.lz
$ cd icewm-1.8.2
...
[4]: https://github.com/ice-wm/icewm/releases/download/1.8.2/icewm-1.8.2.tar.lz
