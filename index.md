...
The [latest][15] released version is [3.3.2][4] (2023-03-13).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/3.3.2/icewm-3.3.2.tar.lz
$ tar -x --lzip -vpf icewm-3.3.2.tar.lz
$ cd icewm-3.3.2
...
[4]: https://github.com/ice-wm/icewm/releases/download/3.3.2/icewm-3.3.2.tar.lz
