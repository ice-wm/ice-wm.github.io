...
The [latest][15] released version is [3.1.0][4] (2022-10-24).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/3.1.0/icewm-3.1.0.tar.lz
$ tar -x --lzip -vpf icewm-3.1.0.tar.lz
$ cd icewm-3.1.0
...
[4]: https://github.com/ice-wm/icewm/releases/download/3.1.0/icewm-3.1.0.tar.lz
