...
The [latest][15] released version is [2.9.2][4] (2021-12-07).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/2.9.2/icewm-2.9.2.tar.lz
$ tar -x --lzip -vpf icewm-2.9.2.tar.lz
$ cd icewm-2.9.2
...
[4]: https://github.com/ice-wm/icewm/releases/download/2.9.2/icewm-2.9.2.tar.lz
