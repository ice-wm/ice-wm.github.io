...
The [latest][15] released version is [1.6.4][4] (2020-01-07).
...
```bash
$ curl -L -s https://github.com/ice-wm/icewm/releases/download/1.6.4/icewm-1.6.4.tar.lz | tar xvpf - --lzip
$ cd icewm-1.6.4
...
[4]: https://github.com/ice-wm/icewm/releases/download/1.6.4/icewm-1.6.4.tar.lz
