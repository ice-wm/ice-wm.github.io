...
The [latest][15] released version is [2.9.3][4] (2021-12-21).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/2.9.3/icewm-2.9.3.tar.lz
$ tar -x --lzip -vpf icewm-2.9.3.tar.lz
$ cd icewm-2.9.3
...
[4]: https://github.com/ice-wm/icewm/releases/download/2.9.3/icewm-2.9.3.tar.lz
