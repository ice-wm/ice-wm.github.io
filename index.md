...
The [latest][15] released version is [1.8.1][4] (2020-08-31).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/1.8.1/icewm-1.8.1.tar.lz
$ tar -x --lzip -vpf icewm-1.8.1.tar.lz
$ cd icewm-1.8.1
...
[4]: https://github.com/ice-wm/icewm/releases/download/1.8.1/icewm-1.8.1.tar.lz
