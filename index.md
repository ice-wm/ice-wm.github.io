...
The [latest][15] released version is [4.0.0][4] (2026-01-01).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/4.0.0/icewm-4.0.0.tar.lz
$ tar -x --lzip -vpf icewm-4.0.0.tar.lz
$ cd icewm-4.0.0
...
```bash
$ pkg-config --modversion x11 xext xcomposite xcursor xdamage xfixes xres xrender xrandr xinerama xft fontconfig sm ice sndfile alsa ao gio-2.0 gio-unix-2.0 gdk-pixbuf-xlib-2.0 imlib2 librsvg-2.0 xpm libpng libjpeg
# or simpler:
$ ./rebuild.sh -d
```
...
[4]: https://github.com/ice-wm/icewm/releases/download/4.0.0/icewm-4.0.0.tar.lz
...
[19]: https://specifications.freedesktop.org/wm-spec/latest/index.html
