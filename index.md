...
The [latest][15] released version is [2.9.8][4] (2022-07-18).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/2.9.8/icewm-2.9.8.tar.lz
$ tar -x --lzip -vpf icewm-2.9.8.tar.lz
$ cd icewm-2.9.8
...
[4]: https://github.com/ice-wm/icewm/releases/download/2.9.8/icewm-2.9.8.tar.lz
