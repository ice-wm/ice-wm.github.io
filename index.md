...
The [latest][15] released version is [2.9.6][4] (2022-02-23).
...
```bash
$ wget https://github.com/ice-wm/icewm/releases/download/2.9.6/icewm-2.9.6.tar.lz
$ tar -x --lzip -vpf icewm-2.9.6.tar.lz
$ cd icewm-2.9.6
...
[4]: https://github.com/ice-wm/icewm/releases/download/2.9.6/icewm-2.9.6.tar.lz
