...
The [latest][15] released version is [1.6.0][4] (2019-08-18).
...
```bash
$ curl -L -s https://github.com/ice-wm/icewm/releases/download/1.6.0/icewm-1.6.0.tar.xz | tar Jxvpf -
$ cd icewm-1.6.0
...
[4]: https://github.com/ice-wm/icewm/releases/download/1.6.0/icewm-1.6.0.tar.xz
